...
def add_favorite_planet(id_user, planet_id):
    ...
    if favorite_planet:
        return jsonify({"msg": "Planet is already a favorite"}), 400  # Si ya existe, se puede retornar un error
    # Crear y agregar el nuevo favorito
...
def add_favorite_person(id_user, id_people):
    ...
    if favorite_person:
        return jsonify({"msg": "Person is already a favorite"}), 400  # Si ya existe, se puede retornar un error
    # Crear y agregar el nuevo favorito
